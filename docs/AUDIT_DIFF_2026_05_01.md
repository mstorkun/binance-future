...
| 7 | Test coverage too narrow | Yes | Confirmed | Tests increased to 71 plus 3 subtests, but strategy/risk/order tests remain thin. |
...
| 39 | Tests increased | Current test count is 71 plus 3 subtests, but coverage is still not enough for live funds. |
...
2. Add risk-adjusted metrics and multiple-testing controls.
3. Add correlation stress and pattern-weight ablations.
