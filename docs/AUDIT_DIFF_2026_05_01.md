...
| 7 | Test coverage too narrow | Yes | Confirmed | Tests increased to 87 plus 3 subtests, but strategy/risk/order tests remain thin. |
...
| 39 | Tests increased | Current test count is 87 plus 3 subtests, but coverage is still not enough for live funds. |
